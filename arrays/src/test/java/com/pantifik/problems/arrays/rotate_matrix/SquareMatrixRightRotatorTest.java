...
import com.pantifik.problems.arrays.transpose_matrix.SquareMatrixTranspose;
...
class SquareMatrixRightRotatorTest {
  ...
  @BeforeEach
  void setUp() {
    this.rotator = new SquareMatrixRightRotatorUsingTranspose(new SquareMatrixTranspose());
  }
