...
class CombinationsWithRepetitionsTest {

  CombinationsGenerator combinationsGenerator;

  @BeforeEach
  void setUp() {
    combinationsGenerator = new CombinationsWithRepetitions();
  }
  ...
  private static Stream<Arguments> combinationsCountProvider() {
    return Stream.of(Arguments.of(CombinationsRequest.of(List.of(1), 1), 1),
        ...
        Arguments.of(CombinationsRequest.of(List.of(1, 2), 2), 3),
        Arguments.of(CombinationsRequest.of(List.of(1, 2, 3), 2), 6),
        Arguments.of(CombinationsRequest.of(List.of(1, 2, 3, 4, 5), 3), 35));
  }
  ...
  private static Stream<Arguments> combinationsGenerateProvider() {
    return Stream.of(Arguments.of(CombinationsRequest.of(List.of(1), 1),
        ...
        Arguments.of(CombinationsRequest.of(List.of(1, 2), 2),
            List.of(List.of(1, 1), List.of(1, 2), List.of(2, 2))),
        Arguments.of(CombinationsRequest.of(List.of(1, 2, 3), 2),
            List.of(List.of(1, 1), List.of(1, 2), List.of(1, 3), List.of(2, 2), List.of(2, 3)
                , List.of(3, 3))),
        Arguments.of(CombinationsRequest.of(List.of(1, 2, 3, 4), 2),
            List.of(List.of(1, 1), List.of(1, 2), List.of(1, 3), List.of(1, 4),
                List.of(2, 2), List.of(2, 3), List.of(2, 4), List.of(3, 3), List.of(3, 4), List.of(4, 4))));
  }
